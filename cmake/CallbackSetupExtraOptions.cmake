...
MACRO(TRIBITS_REPOSITORY_SETUP_EXTRA_OPTIONS)
  ...
  IF (Trilinos_ENABLE_CI_TEST_MODE)
    ...
    # Disable currently-failing Domi tests (#828)
    SET(Domi_MDMap_UnitTests_1D_1_MPI_1_DISABLE ON)
    SET(Domi_MDMap_UnitTests_1D_2_MPI_2_DISABLE ON)
    SET(Domi_MDMap_UnitTests_1D_4_MPI_4_DISABLE ON)
    SET(Domi_MDMap_UnitTests_2D_1_1_MPI_1_DISABLE ON)
    SET(Domi_MDMap_UnitTests_2D_1_2_MPI_2_DISABLE ON)
    SET(Domi_MDMap_UnitTests_2D_2_1_MPI_2_DISABLE ON)
    SET(Domi_MDMap_UnitTests_2D_1_4_MPI_4_DISABLE ON)
    SET(Domi_MDMap_UnitTests_2D_2_2_MPI_4_DISABLE ON)
    SET(Domi_MDMap_UnitTests_2D_4_1_MPI_4_DISABLE ON)
    SET(Domi_MDMap_UnitTests_3D_1_1_1_MPI_1_DISABLE ON)
    SET(Domi_MDMap_UnitTests_3D_1_1_2_MPI_2_DISABLE ON)
    SET(Domi_MDMap_UnitTests_3D_1_2_1_MPI_2_DISABLE ON)
    SET(Domi_MDMap_UnitTests_3D_2_1_1_MPI_2_DISABLE ON)
    SET(Domi_MDMap_UnitTests_3D_1_1_4_MPI_4_DISABLE ON)
    SET(Domi_MDMap_UnitTests_3D_1_2_2_MPI_4_DISABLE ON)
    SET(Domi_MDMap_UnitTests_3D_1_4_1_MPI_4_DISABLE ON)
    SET(Domi_MDMap_UnitTests_3D_2_1_2_MPI_4_DISABLE ON)
    SET(Domi_MDMap_UnitTests_3D_2_2_1_MPI_4_DISABLE ON)
    SET(Domi_MDMap_UnitTests_3D_4_1_1_MPI_4_DISABLE ON)
