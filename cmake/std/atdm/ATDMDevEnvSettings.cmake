...
IF (
  (NOT "$ENV{ATDM_CONFIG_BLAS_LIBRARY_DIRS}" STREQUAL "")
  AND
  (NOT "$ENV{ATDM_CONFIG_BLAS_LIBRARY_NAMES}" STREQUAL "")
  )
  ATDM_SET_CACHE(BLAS_LIBRARY_DIRS "$ENV{ATDM_CONFIG_BLAS_LIBRARY_DIRS}" CACHE FILEPATH)
  ATDM_SET_CACHE(BLAS_LIBRARY_NAMES "$ENV{ATDM_CONFIG_BLAS_LIBRARY_NAMES}" CACHE STRING)
ELSEIF (NOT "$ENV{ATDM_CONFIG_BLAS_LIBS}" STREQUAL "")
  ATDM_SET_CACHE(TPL_BLAS_LIBRARIES "$ENV{ATDM_CONFIG_BLAS_LIBS}" CACHE FILEPATH)
ELSE()
  MESSAGE(SEND_ERROR "Must set env vars ATDM_CONFIG_BLAS_LIBRARY_DIRS and"
    " ATDM_CONFIG_BLAS_LIBRARY_NAMES or the env var ATDM_CONFIG_BLAS_LIBS")
ENDIF()
...
IF (
  (NOT "$ENV{ATDM_CONFIG_LAPACK_LIBRARY_DIRS}" STREQUAL "")
  AND
  (NOT "$ENV{ATDM_CONFIG_LAPACK_LIBRARY_NAMES}" STREQUAL "")
  )
  ATDM_SET_CACHE(LAPACK_LIBRARY_DIRS "$ENV{ATDM_CONFIG_LAPACK_LIBRARY_DIRS}" CACHE FILEPATH)
  ATDM_SET_CACHE(LAPACK_LIBRARY_NAMES "$ENV{ATDM_CONFIG_LAPACK_LIBRARY_NAMES}" CACHE STRING)
ELSEIF (NOT "$ENV{ATDM_CONFIG_LAPACK_LIBS}" STREQUAL "")
  ATDM_SET_CACHE(TPL_LAPACK_LIBRARIES "$ENV{ATDM_CONFIG_LAPACK_LIBS}" CACHE FILEPATH)
ELSE()
  MESSAGE(SEND_ERROR "Must set env vars ATDM_CONFIG_LAPACK_LIBRARY_DIRS and"
    " ATDM_CONFIG_LAPACK_LIBRARY_NAMES or the env var ATDM_CONFIG_LAPACK_LIBS")
ENDIF()
